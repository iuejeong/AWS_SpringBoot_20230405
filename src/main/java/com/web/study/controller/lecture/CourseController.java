...
public class CourseController {
	...
	@PostMapping("/course")
	public ResponseEntity<? extends ResponseDto> courseRegiste(@RequestBody CourseReqDto courseReqDto) {
	...
	public ResponseEntity<? extends ResponseDto> searchCourse(@Valid SearchCourseReqDto searchValue, BindingResult bindingResult) {	// Valid와 BindingResult는 세트

		
		return ResponseEntity.ok().body(DataResponseDto.of(courseService.searchCourse(searchValue.getType(), searchValue.getSearchValue())));
	}
